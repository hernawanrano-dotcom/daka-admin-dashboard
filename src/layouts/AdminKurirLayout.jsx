// apps/admin-dashboard/src/layouts/AdminKurirLayout.jsx
import React, { useState } from 'react';
import { Outlet, useNavigate } from 'react-router-dom';
import { useAuth } from '../contexts/AuthContext';

export default function AdminKurirLayout() {
  ...
  return (
    <div className="adminkurir-container">
